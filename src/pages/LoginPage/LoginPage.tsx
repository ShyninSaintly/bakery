            ...
            <Form className={classes.LoginPageForm}>
                ...
                <div className={classes.FormContentContainer}>
                    <TextField name="username" type="text" isRequired>
                        ...
                        />
                        <FieldError className={classes.LoginPageErrorMessage}>
                            Заполните поле логин корректно
                        </FieldError>
                    </TextField>
                    <TextField name="password" type="password" isRequired>
                        ...
                        />
                        <FieldError className={classes.LoginPageErrorMessage}>
                            Заполните поле пароля корректно
                        </FieldError>
                    </TextField>
                    <div className={classes.LoginPageButtonContainer}>
                        <Button type="button" className={classes.LoginPageBtn}>
                            Регистрация
                        </Button>
                        <Button type="submit" onClick={handleSubmit} className={classes.LoginPageBtn}>
                            Войти
                        </Button>
                    </div>
                </div>
